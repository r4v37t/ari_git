...
if ($halaman_aktif > 1)
{
$link_halaman .= " <a href=$_SERVER[PHP_SELF]?module=$_GET[module]&agenda=1><< First</a> | ";
}

if (($halaman_aktif-1) > 0)
{
$previous = $halaman_aktif-1;
$link_halaman .= "<a href=$_SERVER[PHP_SELF]?module=$_GET[module]&agenda=$previous>< Previous</a> | ";
}
...
{
$link_halaman .= "<a href=$_SERVER[PHP_SELF]?module=$_GET[module]&agenda=$i>$i</a> | ";
}
$link_halaman .= " ";
}
...
{
$next=$halaman_aktif+1;
$link_halaman .= " <a href=$_SERVER[PHP_SELF]?module=$_GET[module]&agenda=$next>Next ></a> ";
}

if (($halaman_aktif != $jmlhalaman) && ($jmlhalaman != 0))
{
$link_halaman .= " | <a href=$_SERVER[PHP_SELF]?module=$_GET[module]&agenda=$jmlhalaman>Last >></a> ";
}
return $link_halaman;
}
