<div class="row-fluid">
	<div class="span12">
		...
		if(isset($_POST['simpan'])){
			$file='upload_blog/'.$_FILES['gambar']['name'];
			if(move_uploaded_file($_FILES['gambar']['tmp_name'],$file)){
				$id="struktur:$_SESSION[ref]";
				$q=mysql_query("update blog_konten set isi='$file' where konten_id='$id'");
				if($q){
				?>
			...
			?><script>setTimeout(function(){ location.href='?menu=blog-struktur'; },500);</script><?php
		}
		$id="struktur:$_SESSION[ref]";
