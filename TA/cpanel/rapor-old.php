...
?>
<?php
$qq=mysql_query("select * from sia_siswa where nis='$nis'");
...
<table width="790" height="1120" style="page-break-after: always;">
	...
	<tr height="10">
		<td align="left" >&nbsp;</td>
		<td align="center" colspan="2" style="border: 2px solid black;"><?php echo $hh['nama']; ?>&nbsp;</td>
		<td align="center" >&nbsp;</td>
	</tr>
	<tr height="10">
	...
	<tr height="10">
		<td align="center" >&nbsp;</td>
		<td align="center" colspan="2" style="border: 2px solid black;"><?php echo $hh['nis']; ?>&nbsp;</td>
		<td align="center" >&nbsp;</td>
	</tr>
	<tr height="300" >
