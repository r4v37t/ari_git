			...
			<div class="widget-content nopadding">
				<form method="post" class="form-horizontal">
					...
					<div class="control-group">
						...
						<div class="controls"><input type="text" name="alamat" class="span20" placeholder="Alamat Guru Guru" value="<?php echo $h['alamat']; ?>" /></div>
					</div>
					<div class="control-group">
					...
					<div class="widget-box">
						...
						<div class="widget-content nopadding">
							<form method="post" class="form-horizontal" enctype="multipart/form-data" >
								<div class="control-group">
									<label class="control-label">NIP Guru :</label>
									<div class="controls"><input type="text" name="nip" class="span20" placeholder="NIP Guru" /></div>
								</div>
								<div class="control-group">
									<label class="control-label">Nama Guru :</label>
									<div class="controls"><input type="text" name="nama" class="span20" placeholder="Nama Guru" /></div>
								</div>
								<div class="control-group">
									<label class="control-label">Alamat :</label>
