...
<section id="content">
	...
	$q=mysql_query("select * from web_pengda where tipe=1 order by pengda_id desc limit $awal,$batas");
	...
	<ul class="pagination">
		...
		?>
		<li><a href="?menu=pengumuman&hal=<?php echo $x+1; ?>" class="<?php echo (($x+1)==$hal)?'current':''; ?>" ><?php echo $x+1; ?></a></li>
		<?php
		}
		?>
	</ul>
